    ...
    <cc1:UmbracoPanel ID="ScheduledTaskPanel" runat="server">
        ...
        <cc1:Pane ID="NotifyPane" runat="server">
            <cc1:PropertyPanel ID="NotifyPanel" runat="server" Text="">
                <asp:TextBox ID="NotifyTextbox" runat="server" MaxLength="250" CssClass="umbEditorTextField" /><asp:RegularExpressionValidator ID="NotifyAdressValidator" runat="server" ControlToValidate="NotifyTextbox" Text="*" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" />
            </cc1:PropertyPanel>
        </cc1:Pane>
