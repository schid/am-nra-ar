...
<%@ Register src="ImportSteps/ContentImport/SelectUmbracoTypeAndLocation.ascx" tagname="SelectUmbracoTypeAndLocation" tagprefix="CMSImport" %>
...
<%@ Register src="ImportSteps/MemberImport/SelectMembertype.ascx" tagname="SelectMembertype" tagprefix="CMSImport" %>
...
<asp:PlaceHolder ID="Step3PlaceHolderContent" runat="server" Visible="False"><CMSImport:SelectUmbracoTypeAndLocation ID="SelectUmbracoTypeAndLocationStep" runat="server" /></asp:PlaceHolder>
<asp:PlaceHolder ID="Step3PlaceHolderMember" runat="server" Visible="False"><CMSImport:SelectMembertype ID="SelectMembertypeStep" runat="server" /></asp:PlaceHolder>
...
<asp:Button ID="PreviousButton" runat="server"  Text="" CausesValidation="false" OnClick="PreviousButton_Click" CssClass="btn wizardButton"  /><asp:Button ID="NextButton" runat="server" Text=""  OnClick="NextButton_Click" CssClass="btn btn-success wizardButton"  />
